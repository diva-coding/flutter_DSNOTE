class Endpoints {
  ...
  static const String baseURLCustomerSupport = "https://simobile.singapoly.com";

  static const String news = "$baseURL/news";
  static const String datas = "$baseURLLive/api/datas";
  static const String customerServiceDatas = "$baseURLCustomerSupport/api/customer-service/2215091034";
}